	    ...
	    <div class="collapse navbar-collapse" id="navbarSupportedContent">
	        ...
	        <div class="m-auto">
	            <?php
				 		if($logged){
				 	?>
				 	<a href="#" class="btn" style="background: #654573; color: #fff;">Dashboard</a>
				 			<li><a href="../dash/logout.php">Logout</a></li>
				 			<li><a href="./dash">My account</a></li>
				 	<?php
				 		}else{
				 	?>
				 			<li><a href="dash/examples/login.php">Login</a></li>
				 			<li><a href="dash/examples/register.php">Register</a></li>
				 	<?php
				 		}
				 	?>
	            	
				 			<a href="#" class="btn" style="background: #654573; color: #fff;">Register</a>
